...
export default function App(){
  ...
  return(
    <div className="app-shell" style={{...shellStyle,display:"flex",flexDirection:"column"}} onClick={()=>moreMenu&&setMoreMenu(null)}>
      ...
      {/* 올리기 */}
      {screen==="post"&&(<div style={{display:"flex",flexDirection:"column",height:"100%",background:BG}}>
      ...
      {/* 마이페이지 */}
      {screen==="mypage"&&(<div style={{display:"flex",flexDirection:"column",height:"100%",background:BG}}>
