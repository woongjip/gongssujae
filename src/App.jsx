...
export default function App(){
  ...
  function markChatRead(chatId){
    ...
    updateDoc(doc(db,"chats",chatId),{[`lastRead_${currentUser.uid}`]:serverTimestamp()}).catch(()=>{});
  }
  ...
  const unreadChatCount=useMemo(()=>chatRooms.filter(r=>{
    ...
    const myLastRead=uid?r[`lastRead_${uid}`]:null;
